...
public class IdempotencyService {
    ...
    public <T> Optional<T> findCachedResponse(String key, Class<T> responseType) {
        ...
        return metrics.timeLookup(operationType, hit, () -> record.map(ik -> {
    ...
    /**
     * Internal method to purge expired idempotency keys.
     * Called by IdempotencyPurgeScheduler.
     */
    void purgeExpiredKeysInternal() {
