...
/**
 * Gateway for managing EVP (Endereço Virtual de Pagamento) PIX keys at Efí Bank.<br>
 *
...
public class EfiEvpGateway {
	...
	/**
	 * Creates a new EVP (random) PIX key via Efí Bank POST /v2/gn/evp.
	 *
	 ...
	 * @throws PixGatewayException if the account has reached its EVP key limit (400)
	...
	/**
	 * Deletes a random (EVP) PIX key from Efí Bank via DELETE /v2/gn/evp/{key}.
	 *
	 ...
	 * @throws PixGatewayException if deletion fails
	 */
	...
	private record EvpCreateResponse(String key) { }

	/**
	 * Response for GET /v2/gn/evp: { "keys": ["uuid1", "uuid2"] }
	 */
	@JsonIgnoreProperties(ignoreUnknown = true)
	private record EvpListResponse(List<String> keys) { }
}
